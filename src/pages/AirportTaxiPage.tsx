  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="bg-card border-b border-border/50 px-6 py-4 flex items-center gap-4 sticky top-0 z-10 backdrop-blur-md bg-card/80">
        ...
        <div>
          <h1 className="text-lg font-black text-foreground">تكسي المطار</h1>
          <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-widest">Airport Taxi Service</p>
        </div>
      </div>
